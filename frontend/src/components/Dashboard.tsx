...
export function Dashboard({ data: d, position, onNavigate, onOpenReportModal }: DashboardProps) {
  if (position === 'main') return <MainContent d={d} onNavigate={onNavigate} onOpenReportModal={onOpenReportModal} />;
...
function MainContent({
  ...
  return (
    <>
      ...
      <div className="stage">
        <RiyadhGoogleMap mode={d.mode} sensors={d.sensors} hotspots={d.mapHotspots} heatmapPoints={d.mapHeatmapPoints} zoomPreset={d.zoomPreset} focusTarget={d.mapFocusTarget} onViewportChange={d.handleMapViewportChange} onPickSensor={d.handlePickSensor} activeMissions={d.activeMissions} />
